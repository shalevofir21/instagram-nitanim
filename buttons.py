...
from constants import VIEW_MORE_COMMENTS_X_POS, VIEW_MORE_COMMENTS_Y_POS, \
    LIKE_BUTTON_X_POS, LIKE_BUTTON_Y_POS, LIKE_BUTTON_WIDTH, \
    LIKE_BUTTON_HEIGHT, COMMENT_BUTTON_X_POST, COMMENT_BUTTON_Y_POS, \
    COMMENT_BUTTON_WIDTH, COMMENT_BUTTON_HEIGHT, VIEW_MORE_COMMENT_WIDTH, \
    VIEW_MORE_COMMENT_HEIGHT, POST_X_POS, POST_Y_POS, POST_WIDTH, POST_HEIGHT
